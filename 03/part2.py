...
def move(origin,movement):
  ...
  if direction == "U":
    newx = origin[0]
    newy = origin[1] + value
    for i in range(origin[1]+1,newy+1):
      move_list.append((origin[0], i ))

  elif direction == "D":
    newx = origin[0]
    newy = origin[1] - value
    for i in range(newy,origin[1]):
      move_list.append((origin[0], i))
    move_list.reverse()
    ...
    newx = origin[0] + value
    newy = origin[1]
    for i in range(origin[0]+1,newx+1):
      move_list.append((i, origin[1]))

  elif direction == "L":
    newx = origin[0] - value
    newy = origin[1]
    for i in range(newx,origin[0]):
      move_list.append((i, origin[1]))
    move_list.reverse()
...
## MAIN
line1_coordinate_list = [(0,0)]
for i in line1:
  coordinate = move(line1_coordinate_list[-1], i)
  line1_coordinate_list = line1_coordinate_list + coordinate

line2_coordinate_list = [(0,0)]
for i in line2:
  coordinate = move(line2_coordinate_list[-1], i)
  line2_coordinate_list = line2_coordinate_list + coordinate

# find common coordinates
common_coordinates = list(set(line1_coordinate_list).intersection(line2_coordinate_list))

# compute distances
dist_list = []
for coord in common_coordinates:
  sumdistance=line1_coordinate_list.index(coord) + line2_coordinate_list.index(coord)
  dist_list.append((coord, sumdistance))
